...
Figure simpleVolumePlot() {
    ...
    const auto x_coords = linspace(-8, 8, kNumPointsPerDim);
    const auto y_coords = linspace(-8, 8, kNumPointsPerDim);
    const auto z_coords = linspace(-8, 8, kNumPointsPerDim);
...
Figure multiple3dIsosurfaces() {
    constexpr int kNumPointsPerDim = 40;
    const auto x_coords = linspace(-5, 5, kNumPointsPerDim);
    const auto y_coords = linspace(-5, 5, kNumPointsPerDim);
    const auto z_coords = linspace(-5, 5, kNumPointsPerDim);
