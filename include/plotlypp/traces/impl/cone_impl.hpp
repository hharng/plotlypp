...
inline Cone& Cone::anchor(enum Anchor f) {
    switch(f) {
        case Anchor::Tip: json["anchor"] = "tip"; break;
        case Anchor::Tail: json["anchor"] = "tail"; break;
        case Anchor::Cm: json["anchor"] = "cm"; break;
        case Anchor::Center: json["anchor"] = "center"; break;
    }
    return *this;
}
...
inline Cone& Cone::sizemode(enum Sizemode f) {
    switch(f) {
        case Sizemode::Scaled: json["sizemode"] = "scaled"; break;
        case Sizemode::Absolute: json["sizemode"] = "absolute"; break;
        case Sizemode::Raw: json["sizemode"] = "raw"; break;
    }
    return *this;
}
