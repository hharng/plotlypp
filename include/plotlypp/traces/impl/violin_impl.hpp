...
inline Violin& Violin::points(enum Points f) {
    switch(f) {
        case Points::All: json["points"] = "all"; break;
        case Points::Outliers: json["points"] = "outliers"; break;
        case Points::Suspectedoutliers: json["points"] = "suspectedoutliers"; break;
        case Points::False: json["points"] = false; break;
    }
    return *this;
}
...
inline Violin& Violin::scalemode(enum Scalemode f) {
    switch(f) {
        case Scalemode::Width: json["scalemode"] = "width"; break;
        case Scalemode::Count: json["scalemode"] = "count"; break;
    }
    return *this;
}
...
inline Violin& Violin::side(enum Side f) {
    switch(f) {
        case Side::Both: json["side"] = "both"; break;
        case Side::Positive: json["side"] = "positive"; break;
        case Side::Negative: json["side"] = "negative"; break;
    }
    return *this;
}
...
inline Violin& Violin::spanmode(enum Spanmode f) {
    switch(f) {
        case Spanmode::Soft: json["spanmode"] = "soft"; break;
        case Spanmode::Hard: json["spanmode"] = "hard"; break;
        case Spanmode::Manual: json["spanmode"] = "manual"; break;
    }
    return *this;
}
