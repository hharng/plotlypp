...
class Heatmap : public Trace {
 public:
    ...
    Heatmap& autocolorscale(Callable&& c);
    ...
    Heatmap& colorscale(const std::vector<std::pair<double, std::string>>& f);
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, bool&>>>
    Heatmap& hoverongaps(Callable&& c);
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap& hovertemplate(Callable&& c);
    Heatmap& hovertemplate(const std::vector<std::string>& f);

    // Sets the source reference on Chart Studio Cloud for `hovertemplate`.
    Heatmap& hovertemplatesrc(std::string f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap& hovertemplatesrc(Callable&& c);

    // Same as `text`.
    template <typename T, typename = std::enable_if_t<is_data_array_element_v<T>>>
    Heatmap& hovertext(const std::vector<T>& f);
    template <
        typename T, typename Callable,
        typename = std::enable_if_t<is_data_array_element_v<T> && (std::is_invocable_v<Callable, std::vector<T>&>)>>
    Heatmap& hovertext(Callable&& c);

    // Sets the source reference on Chart Studio Cloud for `hovertext`.
    Heatmap& hovertextsrc(std::string f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap& hovertextsrc(Callable&& c);

    // Assigns id labels to each datum. These ids for object constancy of data points during animation. Should be an
    // array of strings, not numbers or any other type.
    template <typename T, typename = std::enable_if_t<is_data_array_element_v<T>>>
    Heatmap& ids(const std::vector<T>& f);
    template <
        typename T, typename Callable,
        typename = std::enable_if_t<is_data_array_element_v<T> && (std::is_invocable_v<Callable, std::vector<T>&>)>>
    Heatmap& ids(Callable&& c);

    // Sets the source reference on Chart Studio Cloud for `ids`.
    Heatmap& idssrc(std::string f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap& idssrc(Callable&& c);

    // Sets the reference to a legend to show this trace in. References to these legends are *legend*, *legend2*,
    // *legend3*, etc. Settings for these legends are set in the layout, under `layout.legend`, `layout.legend2`, etc.
    Heatmap& legend(std::string f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap& legend(Callable&& c);
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap& legendgroup(Callable&& c);
    ...
    Heatmap& legendgrouptitle(Callable&& c);
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, double&>>>
    Heatmap& legendrank(Callable&& c);

    // Sets the width (in px or fraction) of the legend for this trace.
    Heatmap& legendwidth(double f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, double&>>>
    Heatmap& legendwidth(Callable&& c);
    ...
    Heatmap& meta(Callable&& c);
    template <typename T>
    Heatmap& meta(const std::vector<T>& f);

    // Sets the source reference on Chart Studio Cloud for `meta`.
    Heatmap& metasrc(std::string f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap& metasrc(Callable&& c);

    // Sets the trace name. The trace name appears as the legend item and on hover.
    Heatmap& name(std::string f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap& name(Callable&& c);

    // Sets the opacity of the trace.
    Heatmap& opacity(double f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, double&>>>
    Heatmap& opacity(Callable&& c);
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap& texttemplate(Callable&& c);

    // Transposes the z data.
    Heatmap& transpose(bool f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, bool&>>>
    Heatmap& transpose(Callable&& c);

    // Assign an id to this trace, Use this to provide object constancy between traces during animations and
    // transitions.
    Heatmap& uid(std::string f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap& uid(Callable&& c);
    ...
    template <typename T, typename = std::enable_if_t<is_data_array_element_v<T>>>
    Heatmap& x(const std::vector<T>& f);
    template <
        typename T, typename Callable,
        typename = std::enable_if_t<is_data_array_element_v<T> && (std::is_invocable_v<Callable, std::vector<T>&>)>>
    Heatmap& x(Callable&& c);
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap& xhoverformat(Callable&& c);
    ...
    template <typename T, typename = std::enable_if_t<is_data_array_element_v<T>>>
    Heatmap& y(const std::vector<T>& f);
    template <
        typename T, typename Callable,
        typename = std::enable_if_t<is_data_array_element_v<T> && (std::is_invocable_v<Callable, std::vector<T>&>)>>
    Heatmap& y(Callable&& c);
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap& yhoverformat(Callable&& c);
    ...
    // Sets the z data.
    template <typename T, typename = std::enable_if_t<is_data_array_element_v<T>>>
    Heatmap& z(const std::vector<T>& f);
    template <
        typename T, typename Callable,
        typename = std::enable_if_t<is_data_array_element_v<T> && (std::is_invocable_v<Callable, std::vector<T>&>)>>
    Heatmap& z(Callable&& c);
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap& zhoverformat(Callable&& c);
...
class Heatmap::Colorbar {
 public:
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, double&>>>
    Heatmap::Colorbar& borderwidth(Callable&& c);
    ...
    template <typename T, typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, T&>>>
    Heatmap::Colorbar& dtick(Callable&& c);
    ...
    template <typename T, typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, T&>>>
    Heatmap::Colorbar& labelalias(Callable&& c);
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, double&>>>
    Heatmap::Colorbar& len(Callable&& c);
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, double&>>>
    Heatmap::Colorbar& minexponent(Callable&& c);
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, int&>>>
    Heatmap::Colorbar& nticks(Callable&& c);
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, double&>>>
    Heatmap::Colorbar& outlinewidth(Callable&& c);

    // If "true", even 4-digit integers are separated
    Heatmap::Colorbar& separatethousands(bool f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, bool&>>>
    Heatmap::Colorbar& separatethousands(Callable&& c);
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, bool&>>>
    Heatmap::Colorbar& showticklabels(Callable&& c);
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, double&>>>
    Heatmap::Colorbar& thickness(Callable&& c);
    ...
    template <typename T, typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, T&>>>
    Heatmap::Colorbar& tick0(Callable&& c);
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, double&>>>
    Heatmap::Colorbar& tickangle(Callable&& c);
    ...
    Heatmap::Colorbar& tickfont(Callable&& c);
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap::Colorbar& tickformat(Callable&& c);

    Heatmap::Colorbar& tickformatstops(Tickformatstop f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, Tickformatstop&>>>
    Heatmap::Colorbar& tickformatstops(Callable&& c);
    Heatmap::Colorbar& tickformatstops(const std::vector<Tickformatstop>& f);
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, int&>>>
    Heatmap::Colorbar& ticklabelstep(Callable&& c);

    // Sets the tick length (in px).
    Heatmap::Colorbar& ticklen(double f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, double&>>>
    Heatmap::Colorbar& ticklen(Callable&& c);
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap::Colorbar& tickprefix(Callable&& c);
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, double&>>>
    Heatmap::Colorbar& xpad(Callable&& c);
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, double&>>>
    Heatmap::Colorbar& ypad(Callable&& c);
...
class Heatmap::Colorbar::Tickfont {
 public:
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap::Colorbar::Tickfont& family(Callable&& c);
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap::Colorbar::Tickfont& lineposition(Callable&& c);

    // Sets the shape and color of the shadow behind text. *auto* places minimal shadow and applies contrast text font
    // color. See https://developer.mozilla.org/en-US/docs/Web/CSS/text-shadow for additional options.
    Heatmap::Colorbar::Tickfont& shadow(std::string f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap::Colorbar::Tickfont& shadow(Callable&& c);

    Heatmap::Colorbar::Tickfont& size(double f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, double&>>>
    Heatmap::Colorbar::Tickfont& size(Callable&& c);
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, int&>>>
    Heatmap::Colorbar::Tickfont& weight(Callable&& c);

    // Advanced users may modify the JSON representation directly, at their own peril!
    Json json{};
};

class Heatmap::Colorbar::Tickformatstop {
 public:
    ...
    Heatmap::Colorbar::Tickformatstop& enabled(bool f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, bool&>>>
    Heatmap::Colorbar::Tickformatstop& enabled(Callable&& c);
    ...
    Heatmap::Colorbar::Tickformatstop& name(std::string f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap::Colorbar::Tickformatstop& name(Callable&& c);
    ...
    // true`.
    Heatmap::Colorbar::Tickformatstop& templateitemname(std::string f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap::Colorbar::Tickformatstop& templateitemname(Callable&& c);

    // string - dtickformat for described zoom level, the same as *tickformat*
    Heatmap::Colorbar::Tickformatstop& value(std::string f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap::Colorbar::Tickformatstop& value(Callable&& c);
...
class Heatmap::Colorbar::Title {
 public:
    ...
    Heatmap::Colorbar::Title& font(Callable&& c);
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap::Colorbar::Title& text(Callable&& c);
...
class Heatmap::Colorbar::Title::Font {
 public:
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap::Colorbar::Title::Font& family(Callable&& c);
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap::Colorbar::Title::Font& lineposition(Callable&& c);

    // Sets the shape and color of the shadow behind text. *auto* places minimal shadow and applies contrast text font
    // color. See https://developer.mozilla.org/en-US/docs/Web/CSS/text-shadow for additional options.
    Heatmap::Colorbar::Title::Font& shadow(std::string f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap::Colorbar::Title::Font& shadow(Callable&& c);

    Heatmap::Colorbar::Title::Font& size(double f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, double&>>>
    Heatmap::Colorbar::Title::Font& size(Callable&& c);
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, int&>>>
    Heatmap::Colorbar::Title::Font& weight(Callable&& c);
...
class Heatmap::Hoverlabel {
 public:
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap::Hoverlabel& alignsrc(Callable&& c);
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap::Hoverlabel& bgcolorsrc(Callable&& c);
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap::Hoverlabel& bordercolorsrc(Callable&& c);

    // Sets the font used in hover labels.
    Heatmap::Hoverlabel& font(Font f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, Font&>>>
    Heatmap::Hoverlabel& font(Callable&& c);
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, int&>>>
    Heatmap::Hoverlabel& namelength(Callable&& c);
    Heatmap::Hoverlabel& namelength(const std::vector<int>& f);

    // Sets the source reference on Chart Studio Cloud for `namelength`.
    Heatmap::Hoverlabel& namelengthsrc(std::string f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap::Hoverlabel& namelengthsrc(Callable&& c);
...
class Heatmap::Hoverlabel::Font {
 public:
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap::Hoverlabel::Font& colorsrc(Callable&& c);
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap::Hoverlabel::Font& family(Callable&& c);
    Heatmap::Hoverlabel::Font& family(const std::vector<std::string>& f);

    // Sets the source reference on Chart Studio Cloud for `family`.
    Heatmap::Hoverlabel::Font& familysrc(std::string f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap::Hoverlabel::Font& familysrc(Callable&& c);
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap::Hoverlabel::Font& lineposition(Callable&& c);
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap::Hoverlabel::Font& linepositionsrc(Callable&& c);

    // Sets the shape and color of the shadow behind text. *auto* places minimal shadow and applies contrast text font
    // color. See https://developer.mozilla.org/en-US/docs/Web/CSS/text-shadow for additional options.
    Heatmap::Hoverlabel::Font& shadow(std::string f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap::Hoverlabel::Font& shadow(Callable&& c);
    Heatmap::Hoverlabel::Font& shadow(const std::vector<std::string>& f);

    // Sets the source reference on Chart Studio Cloud for `shadow`.
    Heatmap::Hoverlabel::Font& shadowsrc(std::string f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap::Hoverlabel::Font& shadowsrc(Callable&& c);

    Heatmap::Hoverlabel::Font& size(double f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, double&>>>
    Heatmap::Hoverlabel::Font& size(Callable&& c);
    Heatmap::Hoverlabel::Font& size(const std::vector<double>& f);

    // Sets the source reference on Chart Studio Cloud for `size`.
    Heatmap::Hoverlabel::Font& sizesrc(std::string f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap::Hoverlabel::Font& sizesrc(Callable&& c);
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap::Hoverlabel::Font& stylesrc(Callable&& c);
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap::Hoverlabel::Font& textcasesrc(Callable&& c);
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap::Hoverlabel::Font& variantsrc(Callable&& c);

    // Sets the weight (or boldness) of the font.
    Heatmap::Hoverlabel::Font& weight(int f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, int&>>>
    Heatmap::Hoverlabel::Font& weight(Callable&& c);
    Heatmap::Hoverlabel::Font& weight(const std::vector<int>& f);

    // Sets the source reference on Chart Studio Cloud for `weight`.
    Heatmap::Hoverlabel::Font& weightsrc(std::string f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap::Hoverlabel::Font& weightsrc(Callable&& c);
...
class Heatmap::Legendgrouptitle {
 public:
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, Font&>>>
    Heatmap::Legendgrouptitle& font(Callable&& c);

    // Sets the title of the legend group.
    Heatmap::Legendgrouptitle& text(std::string f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap::Legendgrouptitle& text(Callable&& c);
...
class Heatmap::Legendgrouptitle::Font {
 public:
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap::Legendgrouptitle::Font& family(Callable&& c);
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap::Legendgrouptitle::Font& lineposition(Callable&& c);

    // Sets the shape and color of the shadow behind text. *auto* places minimal shadow and applies contrast text font
    // color. See https://developer.mozilla.org/en-US/docs/Web/CSS/text-shadow for additional options.
    Heatmap::Legendgrouptitle::Font& shadow(std::string f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap::Legendgrouptitle::Font& shadow(Callable&& c);

    Heatmap::Legendgrouptitle::Font& size(double f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, double&>>>
    Heatmap::Legendgrouptitle::Font& size(Callable&& c);
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, int&>>>
    Heatmap::Legendgrouptitle::Font& weight(Callable&& c);
...
class Heatmap::Stream {
 public:
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, double&>>>
    Heatmap::Stream& maxpoints(Callable&& c);
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap::Stream& token(Callable&& c);
...
class Heatmap::Textfont {
 public:
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap::Textfont& family(Callable&& c);
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap::Textfont& lineposition(Callable&& c);

    // Sets the shape and color of the shadow behind text. *auto* places minimal shadow and applies contrast text font
    // color. See https://developer.mozilla.org/en-US/docs/Web/CSS/text-shadow for additional options.
    Heatmap::Textfont& shadow(std::string f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Heatmap::Textfont& shadow(Callable&& c);

    Heatmap::Textfont& size(double f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, double&>>>
    Heatmap::Textfont& size(Callable&& c);
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, int&>>>
    Heatmap::Textfont& weight(Callable&& c);
