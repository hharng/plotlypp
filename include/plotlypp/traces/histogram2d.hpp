...
class Histogram2D : public Trace {
 public:
    ...
    Histogram2D& colorscale(const std::vector<std::pair<double, std::string>>& f);
    ...
    Histogram2D& customdata(const std::vector<T>& f);
    template <
    ...
    Histogram2D& hovertemplate(const std::vector<std::string>& f);
    ...
    template <typename T, typename = std::enable_if_t<is_data_array_element_v<T>>>
    Histogram2D& ids(const std::vector<T>& f);
    template <
        typename T, typename Callable,
        typename = std::enable_if_t<is_data_array_element_v<T> && (std::is_invocable_v<Callable, std::vector<T>&>)>>
    ...
    template <typename T>
    Histogram2D& meta(const std::vector<T>& f);
    ...
    template <typename T, typename = std::enable_if_t<is_data_array_element_v<T>>>
    Histogram2D& x(const std::vector<T>& f);
    template <
        typename T, typename Callable,
        typename = std::enable_if_t<is_data_array_element_v<T> && (std::is_invocable_v<Callable, std::vector<T>&>)>>
    ...
    template <typename T, typename = std::enable_if_t<is_data_array_element_v<T>>>
    Histogram2D& y(const std::vector<T>& f);
    template <
        typename T, typename Callable,
        typename = std::enable_if_t<is_data_array_element_v<T> && (std::is_invocable_v<Callable, std::vector<T>&>)>>
    ...
    template <typename T, typename = std::enable_if_t<is_data_array_element_v<T>>>
    Histogram2D& z(const std::vector<T>& f);
    template <
        typename T, typename Callable,
        typename = std::enable_if_t<is_data_array_element_v<T> && (std::is_invocable_v<Callable, std::vector<T>&>)>>
...
class Histogram2D::Colorbar {
 public:
    ...
    Histogram2D::Colorbar& tickformatstops(Tickformatstop f);
    ...
    Histogram2D::Colorbar& tickformatstops(const std::vector<Tickformatstop>& f);
    ...
    // Used with `tickvals`.
    template <typename T, typename = std::enable_if_t<is_data_array_element_v<T>>>
    Histogram2D::Colorbar& ticktext(const std::vector<T>& f);
    template <
        typename T, typename Callable,
        typename = std::enable_if_t<is_data_array_element_v<T> && (std::is_invocable_v<Callable, std::vector<T>&>)>>
    ...
    // `ticktext`.
    template <typename T, typename = std::enable_if_t<is_data_array_element_v<T>>>
    Histogram2D::Colorbar& tickvals(const std::vector<T>& f);
    template <
        typename T, typename Callable,
        typename = std::enable_if_t<is_data_array_element_v<T> && (std::is_invocable_v<Callable, std::vector<T>&>)>>
...
class Histogram2D::Colorbar::Tickformatstop {
 public:
    ...
    Histogram2D::Colorbar::Tickformatstop& enabled(bool f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, bool&>>>
    Histogram2D::Colorbar::Tickformatstop& enabled(Callable&& c);
    ...
    Histogram2D::Colorbar::Tickformatstop& name(std::string f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Histogram2D::Colorbar::Tickformatstop& name(Callable&& c);
    ...
    // true`.
    Histogram2D::Colorbar::Tickformatstop& templateitemname(std::string f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Histogram2D::Colorbar::Tickformatstop& templateitemname(Callable&& c);

    // string - dtickformat for described zoom level, the same as *tickformat*
    Histogram2D::Colorbar::Tickformatstop& value(std::string f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Histogram2D::Colorbar::Tickformatstop& value(Callable&& c);
...
class Histogram2D::Hoverlabel {
 public:
    ...
    Histogram2D::Hoverlabel& namelength(const std::vector<int>& f);
...
class Histogram2D::Hoverlabel::Font {
 public:
    ...
    Histogram2D::Hoverlabel::Font& family(const std::vector<std::string>& f);
    ...
    Histogram2D::Hoverlabel::Font& shadow(const std::vector<std::string>& f);
    ...
    Histogram2D::Hoverlabel::Font& size(const std::vector<double>& f);
    ...
    Histogram2D::Hoverlabel::Font& weight(const std::vector<int>& f);
...
class Histogram2D::Marker {
 public:
    ...
    // Sets the aggregation data.
    template <typename T, typename = std::enable_if_t<is_data_array_element_v<T>>>
    Histogram2D::Marker& color(const std::vector<T>& f);
    template <
        typename T, typename Callable,
        typename = std::enable_if_t<is_data_array_element_v<T> && (std::is_invocable_v<Callable, std::vector<T>&>)>>
