...
class Histogram2Dcontour : public Trace {
 public:
    ...
    Histogram2Dcontour& customdata(Range&& f);
    template <
    ...
    template <typename Range, typename = std::enable_if_t<is_data_array_v<Range>>>
    Histogram2Dcontour& ids(Range&& f);
    template <
        typename T, typename Callable,
        typename = std::enable_if_t<is_data_array_element_v<T> && (std::is_invocable_v<Callable, std::vector<T>&>)>>
...
class Histogram2Dcontour::Colorbar {
 public:
    ...
    Histogram2Dcontour::Colorbar& bgcolor(double f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&> ||
    ...
    Histogram2Dcontour::Colorbar& bordercolor(double f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&> ||
                                                             std::is_invocable_v<Callable, double&>>>
    ...
    Histogram2Dcontour::Colorbar& outlinecolor(double f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&> ||
                                                             std::is_invocable_v<Callable, double&>>>
    ...
    Histogram2Dcontour::Colorbar& tickformatstops(Tickformatstop f);
    ...
    Histogram2Dcontour::Colorbar& tickformatstops(const std::vector<Tickformatstop>& f);
    ...
    // Used with `tickvals`.
    template <typename Range, typename = std::enable_if_t<is_data_array_v<Range>>>
    Histogram2Dcontour::Colorbar& ticktext(Range&& f);
    template <
        typename T, typename Callable,
        typename = std::enable_if_t<is_data_array_element_v<T> && (std::is_invocable_v<Callable, std::vector<T>&>)>>
    ...
    // `ticktext`.
    template <typename Range, typename = std::enable_if_t<is_data_array_v<Range>>>
    Histogram2Dcontour::Colorbar& tickvals(Range&& f);
    template <
        typename T, typename Callable,
        typename = std::enable_if_t<is_data_array_element_v<T> && (std::is_invocable_v<Callable, std::vector<T>&>)>>
...
class Histogram2Dcontour::Colorbar::Tickformatstop {
 public:
    ...
    Histogram2Dcontour::Colorbar::Tickformatstop& dtickrange(const std::vector<double>& f);
    Histogram2Dcontour::Colorbar::Tickformatstop& dtickrange(const std::vector<std::string>& f);
    Histogram2Dcontour::Colorbar::Tickformatstop& dtickrange(const std::vector<std::vector<std::string>>& f);
    Histogram2Dcontour::Colorbar::Tickformatstop& dtickrange(const std::vector<std::vector<double>>& f);
    template <typename Callable,
    ...
    Histogram2Dcontour::Colorbar::Tickformatstop& dtickrange(Callable&& c);

    // Determines whether or not this stop is used. If `false`, this stop is ignored even within its `dtickrange`.
    Histogram2Dcontour::Colorbar::Tickformatstop& enabled(bool f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, bool&>>>
    Histogram2Dcontour::Colorbar::Tickformatstop& enabled(Callable&& c);
    ...
    Histogram2Dcontour::Colorbar::Tickformatstop& name(std::string f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Histogram2Dcontour::Colorbar::Tickformatstop& name(Callable&& c);
    ...
    // true`.
    Histogram2Dcontour::Colorbar::Tickformatstop& templateitemname(std::string f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Histogram2Dcontour::Colorbar::Tickformatstop& templateitemname(Callable&& c);

    // string - dtickformat for described zoom level, the same as *tickformat*
    Histogram2Dcontour::Colorbar::Tickformatstop& value(std::string f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&>>>
    Histogram2Dcontour::Colorbar::Tickformatstop& value(Callable&& c);
...
class Histogram2Dcontour::Hoverlabel {
 public:
    ...
    Histogram2Dcontour::Hoverlabel& bordercolor(double f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&> ||
                                                             std::is_invocable_v<Callable, double&>>>
    ...
    Histogram2Dcontour::Hoverlabel& bordercolor(const std::vector<double>& f);
...
class Histogram2Dcontour::Hoverlabel::Font {
 public:
    ...
    Histogram2Dcontour::Hoverlabel::Font& color(const std::vector<double>& f);
...
class Histogram2Dcontour::Line {
 public:
    ...
    Histogram2Dcontour::Line& color(double f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, std::string&> ||
                                                             std::is_invocable_v<Callable, double&>>>
...
class Histogram2Dcontour::Marker {
 public:
    ...
    // Sets the aggregation data.
    template <typename Range, typename = std::enable_if_t<is_data_array_v<Range>>>
    Histogram2Dcontour::Marker& color(Range&& f);
    template <
        typename T, typename Callable,
        typename = std::enable_if_t<is_data_array_element_v<T> && (std::is_invocable_v<Callable, std::vector<T>&>)>>
