...
class Choroplethmapbox : public Trace {
 public:
    Choroplethmapbox()
    : Trace() {
        json["type"] = "choroplethmapbox";
    }
    Choroplethmapbox(std::string jsonStr)
    ...
    Choroplethmapbox& colorbar(Callable&& c);
    ...
    Choroplethmapbox& hoverinfo(std::initializer_list<Hoverinfo> flags);
    Choroplethmapbox& hoverinfo(HoverinfoExtra extra);
    ...
    Choroplethmapbox& hoverlabel(Callable&& c);
    ...
    Choroplethmapbox& legendgrouptitle(Callable&& c);
    ...
    Choroplethmapbox& marker(Callable&& c);
    ...
    Choroplethmapbox& selected(Callable&& c);
    ...
    Choroplethmapbox& stream(Callable&& c);
    ...
    Choroplethmapbox& unselected(Callable&& c);

    // Determines whether or not this trace is visible. If *legendonly*, the trace is not drawn, but can appear as a
    // legend item (provided that the legend itself is visible).
    // - Default: True
    Choroplethmapbox& visible(enum Visible f);
...
class Choroplethmapbox::Colorbar {
 public:
    ...
    // 1G. If *B*, 1B.
    // - Default: B
    Choroplethmapbox::Colorbar& exponentformat(enum Exponentformat f);
    ...
    // - Default: fraction
    Choroplethmapbox::Colorbar& lenmode(enum Lenmode f);
    ...
    // - Default: v
    Choroplethmapbox::Colorbar& orientation(enum Orientation f);
    ...
    // - Default: all
    Choroplethmapbox::Colorbar& showexponent(enum Showexponent f);
    ...
    // - Default: all
    Choroplethmapbox::Colorbar& showtickprefix(enum Showtickprefix f);

    // Same as `showtickprefix` but for tick suffixes.
    // - Default: all
    Choroplethmapbox::Colorbar& showticksuffix(enum Showticksuffix f);
    ...
    // - Default: pixels
    Choroplethmapbox::Colorbar& thicknessmode(enum Thicknessmode f);
    ...
    Choroplethmapbox::Colorbar& tickfont(Callable&& c);
    ...
    Choroplethmapbox::Colorbar& ticklabeloverflow(enum Ticklabeloverflow f);
    ...
    // - Default: outside
    Choroplethmapbox::Colorbar& ticklabelposition(enum Ticklabelposition f);
    ...
    Choroplethmapbox::Colorbar& tickmode(enum Tickmode f);
    ...
    // - Default:
    Choroplethmapbox::Colorbar& ticks(enum Ticks f);
    ...
    Choroplethmapbox::Colorbar& title(Callable&& c);
    ...
    Choroplethmapbox::Colorbar& xanchor(enum Xanchor f);
    ...
    // - Default: paper
    Choroplethmapbox::Colorbar& xref(enum Xref f);
    ...
    Choroplethmapbox::Colorbar& yanchor(enum Yanchor f);
...
// Sets the color bar's tick label font
class Choroplethmapbox::Colorbar::Tickfont {
 public:
    Tickfont() = default;
    ...
    // - Extras ['none']
    Choroplethmapbox::Colorbar::Tickfont& lineposition(std::initializer_list<Lineposition> flags);
    Choroplethmapbox::Colorbar::Tickfont& lineposition(LinepositionExtra extra);
    ...
    // - Default: normal
    Choroplethmapbox::Colorbar::Tickfont& style(enum Style f);

    // Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each
    // word capitalized.
    // - Default: normal
    Choroplethmapbox::Colorbar::Tickfont& textcase(enum Textcase f);

    // Sets the variant of the font.
    // - Default: normal
    Choroplethmapbox::Colorbar::Tickfont& variant(enum Variant f);
...
class Choroplethmapbox::Colorbar::Tickformatstop {
 public:
    ...
    Choroplethmapbox::Colorbar::Tickformatstop& dtickrange(const std::vector<double>& f);
...
class Choroplethmapbox::Colorbar::Title {
 public:
    ...
    // Sets this color bar's title font.
    Choroplethmapbox::Colorbar::Title& font(Font f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, Font&>>>
    Choroplethmapbox::Colorbar::Title& font(Callable&& c);
    ...
    Choroplethmapbox::Colorbar::Title& side(enum Side f);
...
// Sets this color bar's title font.
class Choroplethmapbox::Colorbar::Title::Font {
 public:
    Font() = default;
    ...
    // - Flags: ['under', 'over', 'through']
    // - Extras ['none']
    Choroplethmapbox::Colorbar::Title::Font& lineposition(std::initializer_list<Lineposition> flags);
    Choroplethmapbox::Colorbar::Title::Font& lineposition(LinepositionExtra extra);
    ...
    // Sets whether a font should be styled with a normal or italic face from its family.
    // - Default: normal
    Choroplethmapbox::Colorbar::Title::Font& style(enum Style f);

    // Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each
    // word capitalized.
    // - Default: normal
    Choroplethmapbox::Colorbar::Title::Font& textcase(enum Textcase f);

    // Sets the variant of the font.
    // - Default: normal
    Choroplethmapbox::Colorbar::Title::Font& variant(enum Variant f);
...
class Choroplethmapbox::Hoverlabel {
 public:
    ...
    // - Default: auto
    Choroplethmapbox::Hoverlabel& align(enum Align f);
    Choroplethmapbox::Hoverlabel& align(const std::vector<enum Align>& f);
    ...
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, Font&>>>
    Choroplethmapbox::Hoverlabel& font(Callable&& c);
...
// Sets the font used in hover labels.
class Choroplethmapbox::Hoverlabel::Font {
 public:
    Font() = default;
    Font(std::string jsonStr)
    : json(parse(std::move(jsonStr))) {}
    ...
    // - Flags: ['under', 'over', 'through']
    // - Extras ['none']
    Choroplethmapbox::Hoverlabel::Font& lineposition(std::initializer_list<Lineposition> flags);
    Choroplethmapbox::Hoverlabel::Font& lineposition(LinepositionExtra extra);
    ...
    // Sets whether a font should be styled with a normal or italic face from its family.
    // - Default: normal
    Choroplethmapbox::Hoverlabel::Font& style(enum Style f);
    Choroplethmapbox::Hoverlabel::Font& style(const std::vector<enum Style>& f);
    ...
    // word capitalized.
    // - Default: normal
    Choroplethmapbox::Hoverlabel::Font& textcase(enum Textcase f);
    Choroplethmapbox::Hoverlabel::Font& textcase(const std::vector<enum Textcase>& f);
    ...
    // Sets the variant of the font.
    // - Default: normal
    Choroplethmapbox::Hoverlabel::Font& variant(enum Variant f);
    Choroplethmapbox::Hoverlabel::Font& variant(const std::vector<enum Variant>& f);
...
class Choroplethmapbox::Legendgrouptitle {
 public:
    ...
    // Sets this legend group's title font.
    Choroplethmapbox::Legendgrouptitle& font(Font f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, Font&>>>
    Choroplethmapbox::Legendgrouptitle& font(Callable&& c);
...
// Sets this legend group's title font.
class Choroplethmapbox::Legendgrouptitle::Font {
 public:
    Font() = default;
    Font(std::string jsonStr)
    : json(parse(std::move(jsonStr))) {}
    ...
    // - Flags: ['under', 'over', 'through']
    // - Extras ['none']
    Choroplethmapbox::Legendgrouptitle::Font& lineposition(std::initializer_list<Lineposition> flags);
    Choroplethmapbox::Legendgrouptitle::Font& lineposition(LinepositionExtra extra);
    ...
    // Sets whether a font should be styled with a normal or italic face from its family.
    // - Default: normal
    Choroplethmapbox::Legendgrouptitle::Font& style(enum Style f);

    // Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each
    // word capitalized.
    // - Default: normal
    Choroplethmapbox::Legendgrouptitle::Font& textcase(enum Textcase f);

    // Sets the variant of the font.
    // - Default: normal
    Choroplethmapbox::Legendgrouptitle::Font& variant(enum Variant f);
...
class Choroplethmapbox::Selected {
 public:
    ...
    Choroplethmapbox::Selected& marker(Marker f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, Marker&>>>
    Choroplethmapbox::Selected& marker(Callable&& c);
...
class Choroplethmapbox::Unselected {
 public:
    ...
    Choroplethmapbox::Unselected& marker(Marker f);
    template <typename Callable, typename = std::enable_if_t<std::is_invocable_v<Callable, Marker&>>>
    Choroplethmapbox::Unselected& marker(Callable&& c);
...
#include "impl/choroplethmapbox_impl.hpp"
