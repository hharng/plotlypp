...
class Densitymapbox : public Trace {
 public:
    ...
    Densitymapbox(std::string jsonStr)
    ...
    Densitymapbox& customdata(Range&& f);
...
class Densitymapbox::Colorbar {
 public:
    ...
    // 1G. If *B*, 1B.
    // - Default: B
    Densitymapbox::Colorbar& exponentformat(enum Exponentformat f);
    ...
    // - Default: fraction
    Densitymapbox::Colorbar& lenmode(enum Lenmode f);
    ...
    // - Default: v
    Densitymapbox::Colorbar& orientation(enum Orientation f);
    ...
    // - Default: all
    Densitymapbox::Colorbar& showexponent(enum Showexponent f);
    ...
    // - Default: all
    Densitymapbox::Colorbar& showtickprefix(enum Showtickprefix f);

    // Same as `showtickprefix` but for tick suffixes.
    // - Default: all
    Densitymapbox::Colorbar& showticksuffix(enum Showticksuffix f);
    ...
    // - Default: pixels
    Densitymapbox::Colorbar& thicknessmode(enum Thicknessmode f);
    ...
    Densitymapbox::Colorbar& ticklabeloverflow(enum Ticklabeloverflow f);
    ...
    // - Default: outside
    Densitymapbox::Colorbar& ticklabelposition(enum Ticklabelposition f);
    ...
    Densitymapbox::Colorbar& tickmode(enum Tickmode f);
    ...
    // - Default:
    Densitymapbox::Colorbar& ticks(enum Ticks f);
    ...
    // Used with `tickvals`.
    template <typename Range, typename = std::enable_if_t<is_data_array_v<Range>>>
    Densitymapbox::Colorbar& ticktext(Range&& f);
    ...
    // `ticktext`.
    template <typename Range, typename = std::enable_if_t<is_data_array_v<Range>>>
    Densitymapbox::Colorbar& tickvals(Range&& f);
    ...
    Densitymapbox::Colorbar& xanchor(enum Xanchor f);
    ...
    // - Default: paper
    Densitymapbox::Colorbar& xref(enum Xref f);
    ...
    Densitymapbox::Colorbar& yanchor(enum Yanchor f);
    ...
    // of the plotting area only.
    // - Default: paper
    Densitymapbox::Colorbar& yref(enum Yref f);
...
// Sets the color bar's tick label font
class Densitymapbox::Colorbar::Tickfont {
 public:
    Tickfont() = default;
    ...
    // - Default: normal
    Densitymapbox::Colorbar::Tickfont& style(enum Style f);

    // Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each
    // word capitalized.
    // - Default: normal
    Densitymapbox::Colorbar::Tickfont& textcase(enum Textcase f);

    // Sets the variant of the font.
    // - Default: normal
    Densitymapbox::Colorbar::Tickfont& variant(enum Variant f);
...
class Densitymapbox::Colorbar::Title {
 public:
    Title() = default;
    ...
    Densitymapbox::Colorbar::Title& side(enum Side f);
...
// Sets this color bar's title font.
class Densitymapbox::Colorbar::Title::Font {
 public:
    Font() = default;
    ...
    // Sets whether a font should be styled with a normal or italic face from its family.
    // - Default: normal
    Densitymapbox::Colorbar::Title::Font& style(enum Style f);

    // Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each
    // word capitalized.
    // - Default: normal
    Densitymapbox::Colorbar::Title::Font& textcase(enum Textcase f);

    // Sets the variant of the font.
    // - Default: normal
    Densitymapbox::Colorbar::Title::Font& variant(enum Variant f);
...
class Densitymapbox::Hoverlabel {
 public:
    Hoverlabel() = default;
    ...
    // - Default: auto
    Densitymapbox::Hoverlabel& align(enum Align f);
    Densitymapbox::Hoverlabel& align(const std::vector<enum Align>& f);
...
// Sets the font used in hover labels.
class Densitymapbox::Hoverlabel::Font {
 public:
    Font() = default;
    Font(std::string jsonStr)
    : json(parse(std::move(jsonStr))) {}
    ...
    // Sets whether a font should be styled with a normal or italic face from its family.
    // - Default: normal
    Densitymapbox::Hoverlabel::Font& style(enum Style f);
    Densitymapbox::Hoverlabel::Font& style(const std::vector<enum Style>& f);
    ...
    // word capitalized.
    // - Default: normal
    Densitymapbox::Hoverlabel::Font& textcase(enum Textcase f);
    Densitymapbox::Hoverlabel::Font& textcase(const std::vector<enum Textcase>& f);
    ...
    // Sets the variant of the font.
    // - Default: normal
    Densitymapbox::Hoverlabel::Font& variant(enum Variant f);
    Densitymapbox::Hoverlabel::Font& variant(const std::vector<enum Variant>& f);
...
class Densitymapbox::Legendgrouptitle {
 public:
...
// Sets this legend group's title font.
class Densitymapbox::Legendgrouptitle::Font {
 public:
    Font() = default;
    Font(std::string jsonStr)
    : json(parse(std::move(jsonStr))) {}
    ...
    // Sets whether a font should be styled with a normal or italic face from its family.
    // - Default: normal
    Densitymapbox::Legendgrouptitle::Font& style(enum Style f);

    // Sets capitalization of text. It can be used to make text appear in all-uppercase or all-lowercase, or with each
    // word capitalized.
    // - Default: normal
    Densitymapbox::Legendgrouptitle::Font& textcase(enum Textcase f);

    // Sets the variant of the font.
    // - Default: normal
    Densitymapbox::Legendgrouptitle::Font& variant(enum Variant f);
...
#include "impl/densitymapbox_impl.hpp"
