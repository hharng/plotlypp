...
class Scatter : public Trace {
 public:
    ...
    Scatter& hoverinfo(std::initializer_list<Hoverinfo> flags);
    Scatter& hoverinfo(HoverinfoExtra extra);
    ...
    // *points*.
    // - Flags: ['points', 'fills']
    Scatter& hoveron(std::initializer_list<Hoveron> flags);
    Scatter& hoveron(HoveronExtra extra);
    ...
    // - Extras ['none']
    Scatter& mode(std::initializer_list<Mode> flags);
    Scatter& mode(ModeExtra extra);
...
class Scatter::Error_X {
 public:
    ...
    template <typename Range, typename = std::enable_if_t<is_data_array_v<Range>>>
    Scatter::Error_X& arrayminus(Range&& f);
...
class Scatter::Error_Y {
 public:
    ...
    // Sets the data corresponding the length of each error bar. Values are plotted relative to the underlying data.
    template <typename Range, typename = std::enable_if_t<is_data_array_v<Range>>>
    Scatter::Error_Y& array(Range&& f);

    // Sets the data corresponding the length of each error bar in the bottom (left) direction for vertical (horizontal)
    // bars Values are plotted relative to the underlying data.
    template <typename Range, typename = std::enable_if_t<is_data_array_v<Range>>>
    Scatter::Error_Y& arrayminus(Range&& f);
...
class Scatter::Fillpattern {
 public:
    ...
    Scatter::Fillpattern& bgcolor(const std::vector<double>& f);
    ...
    Scatter::Fillpattern& fgcolor(const std::vector<double>& f);
...
class Scatter::Hoverlabel {
 public:
    ...
    Scatter::Hoverlabel& bgcolor(const std::vector<double>& f);
    ...
    Scatter::Hoverlabel& bordercolor(const std::vector<double>& f);
...
class Scatter::Hoverlabel::Font {
 public:
    ...
    Scatter::Hoverlabel::Font& color(const std::vector<double>& f);
    ...
    // - Extras ['none']
    Scatter::Hoverlabel::Font& lineposition(std::initializer_list<Lineposition> flags);
    Scatter::Hoverlabel::Font& lineposition(LinepositionExtra extra);
...
class Scatter::Legendgrouptitle::Font {
 public:
    ...
    // - Flags: ['under', 'over', 'through']
    // - Extras ['none']
    Scatter::Legendgrouptitle::Font& lineposition(std::initializer_list<Lineposition> flags);
    Scatter::Legendgrouptitle::Font& lineposition(LinepositionExtra extra);
...
class Scatter::Marker {
 public:
    ...
    Scatter::Marker& color(const std::vector<double>& f);
...
class Scatter::Marker::Colorbar {
 public:
    ...
    Scatter::Marker::Colorbar& tickformatstops(const std::vector<Tickformatstop>& f);
    ...
    // Used with `tickvals`.
    template <typename Range, typename = std::enable_if_t<is_data_array_v<Range>>>
    Scatter::Marker::Colorbar& ticktext(Range&& f);
    ...
    // `ticktext`.
    template <typename Range, typename = std::enable_if_t<is_data_array_v<Range>>>
    Scatter::Marker::Colorbar& tickvals(Range&& f);
...
class Scatter::Marker::Colorbar::Tickfont {
 public:
    ...
    // - Flags: ['under', 'over', 'through']
    // - Extras ['none']
    Scatter::Marker::Colorbar::Tickfont& lineposition(std::initializer_list<Lineposition> flags);
    Scatter::Marker::Colorbar::Tickfont& lineposition(LinepositionExtra extra);
...
class Scatter::Marker::Colorbar::Tickformatstop {
 public:
    ...
    Scatter::Marker::Colorbar::Tickformatstop& dtickrange(const std::vector<double>& f);
    Scatter::Marker::Colorbar::Tickformatstop& dtickrange(const std::vector<std::string>& f);
    Scatter::Marker::Colorbar::Tickformatstop& dtickrange(const std::vector<std::vector<std::string>>& f);
    Scatter::Marker::Colorbar::Tickformatstop& dtickrange(const std::vector<std::vector<double>>& f);

    // Determines whether or not this stop is used. If `false`, this stop is ignored even within its `dtickrange`.
    Scatter::Marker::Colorbar::Tickformatstop& enabled(bool f);
    ...
    Scatter::Marker::Colorbar::Tickformatstop& name(std::string f);
    ...
    // true`.
    Scatter::Marker::Colorbar::Tickformatstop& templateitemname(std::string f);

    // string - dtickformat for described zoom level, the same as *tickformat*
    Scatter::Marker::Colorbar::Tickformatstop& value(std::string f);
...
class Scatter::Marker::Colorbar::Title::Font {
 public:
    ...
    // - Flags: ['under', 'over', 'through']
    // - Extras ['none']
    Scatter::Marker::Colorbar::Title::Font& lineposition(std::initializer_list<Lineposition> flags);
    Scatter::Marker::Colorbar::Title::Font& lineposition(LinepositionExtra extra);
...
class Scatter::Marker::Gradient {
 public:
    ...
    Scatter::Marker::Gradient& color(const std::vector<double>& f);
...
class Scatter::Marker::Line {
 public:
    ...
    Scatter::Marker::Line& color(const std::vector<double>& f);
...
class Scatter::Textfont {
 public:
    ...
    Scatter::Textfont& color(const std::vector<double>& f);
    ...
    // - Flags: ['under', 'over', 'through']
    // - Extras ['none']
    Scatter::Textfont& lineposition(std::initializer_list<Lineposition> flags);
    Scatter::Textfont& lineposition(LinepositionExtra extra);
